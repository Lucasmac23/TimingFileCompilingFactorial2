...
CWD=input("What is your pwd? (You can get this by typing pwd into terminal or by dragging your folder): ").strip()
...
workbook = load_workbook(filename=CWD+'/TotalTimingFileListTemplate1.xlsx')
...
def recursiveFolderExplorer1(directory, mode, timingFileList=[], outputName=[], rewrite=False, override=False, prompt1=False, currentExcelLine=1, newExcelNumber=2):

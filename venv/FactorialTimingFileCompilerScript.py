...
currentSubject=[1]
def recursiveFolderExplorer(directory, mode, firstPass=True, secondPass=False, timingFileList=[], outputName=[]):
    ...
    for SubjNum in SubjList:
        ...
        with open(outputFilePath, 'w') as f:
            ...
            message=("#" * currentSubject[0]) + "_" * (123 - currentSubject[0])
            print(message)
            if currentSubject[0]+1==123:
                currentSubject[0]=0
            else:
                currentSubject[0]+=1
